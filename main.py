...
def no_pruning_with_nested_cross_validation(num_folds, dataset, trained_model_constructor, rng=default_rng()):
...
if __name__ == '__main__':
    ...
    # Historical BAD COMBINATIONS: seed=666, num_folds=10
    seed = 666
